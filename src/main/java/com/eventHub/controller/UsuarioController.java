...
public class UsuarioController {
    ...
    public String cadastroUsuarioPost(@Valid CadastroUsuarioDto usuarioDto,
                                      @Valid CadastroLoginDto loginDto,
                                      @Valid CadastroEnderecoDto enderecoDto){
    ...
    @Transactional
    public String atualizarUsuarioPost(@Valid AtualizacaoUsuarioDto usuarioDto, @Valid AtualizacaoEnderecoDto enderecoDto){
